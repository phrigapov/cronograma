...
export default function ProjectManager() {
  const { data, addProject, deleteProject } = useCronogramaStore();
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-2xl font-bold text-gray-800">Gerenciar Projetos</h2>
        <button
      ...
      {showAddForm && (
        <div className="mb-6 p-4 bg-gray-50 rounded-lg border-2 border-green-200">
          <h3 className="font-semibold mb-3">Adicionar Novo Projeto</h3>
      ...
      {data && data.projects.length > 0 && (
        <div className="space-y-2">
          <h3 className="font-semibold text-gray-700 mb-2">Projetos Existentes:</h3>
